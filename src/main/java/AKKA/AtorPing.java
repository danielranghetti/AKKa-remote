...
public class AtorPing extends UntypedAbstractActor {
    ...
    private ActorSelection atorPong = getContext().actorSelection("akka.tcp://AkkaRemoteServer@127.0.0.1:2556/user/AtorPong");
    ...
    public void onReceive(Object msg) throws Exception {
        if (msg instanceof Mensagem.Iniciar) {
            ...
            loggingAdapter.info("Mensagem a ser mostrada pelo ator ping: {}  ", atorPong.getMensagem());
